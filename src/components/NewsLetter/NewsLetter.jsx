          ...
          <div className="relative">
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 text-white" >
              <div className="mx-auto max-w-screen-md sm:text-center" >
                <h2 className="mb-4 lg:text-3xl font-bold text-2xl" data-aos = "fade-up">Subscribe to our newsletter</h2>
                <p className="mx-auto mb-8 lg:text-lg text-sm font-light md:mb-12 " data-aos = "fade-up">
