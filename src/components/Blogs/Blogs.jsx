...
const Blogs = () => {
    ...
    return (
        <div>
            <section className= "">
                <h2 className="text-center text-5xl font-bold py-10" data-aos = "zoom-in">Latest <span className="text-[#C2A973]">Blogs</span></h2>
                <div className="container max-w-6xl p-6 mx-auto space-y-6 sm:space-y-12">
                    ...
                    <div className="flex justify-center">
                        <button type="button" className="px-6 py-3 text-xl font-semibold rounded-md hover:underline " data-aos= "flip-left">Load more posts...</button>
                    </div>
                </div>
            </section>
        </div>
