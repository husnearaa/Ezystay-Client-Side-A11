        ...
        <div>
            <section className=" ">
                <div className="container flex flex-col justify-center mx-auto mb-10">
                    <div className="grid grid-cols-1 gap-0 lg:grid-cols-6 sm:grid-cols-2">
                        <img className="object-cover w-full  aspect-square" src={"https://i.ibb.co/nzGhJnM/room6.png"} />
                        <img className="object-cover w-full  aspect-square" src={"https://i.ibb.co/w7TVR8W/room5.png"} />
