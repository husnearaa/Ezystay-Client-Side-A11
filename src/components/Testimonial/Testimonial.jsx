...
const Testimonial = () => {
    ...
    return (
        <div>
            <div className="bg-gray-100 mb-10 dark:bg-blue-gray-700">
                <h2 className="lg:text-5xl text-3xl font-bold py-10 text-center mt-10 dark:text-white" data-aos="zoom-in"> What Client <span className="text-[#C2A973]">Say</span></h2>
                <div className="flex justify-around items-center flex-col lg:flex-row w-4/5 mx-auto mt-8 mb-10 ">
                    <div>
                        <div className="relative flex w-full max-w-[26rem] flex-col rounded-xl bg-transparent bg-clip-border  shadow-none mb-10 " data-aos="zoom-out-right">
                            <div className="mb-6 p-0">
                                <p className="block lg:text-lg text-base leading-relaxed text-inherit antialiased dark:text-white">
                            ...
                            <div className="relative mx-0 mt-4 flex items-center gap-4 overflow-hidden rounded-xl bg-transparent bg-clip-border pt-0 pb-8  shadow-none">
                                ...
                                <div className="flex w-full flex-col gap-0.5">
                                    <div className="flex items-center justify-between">
                                        <h5 className="block lg:text-xl text-base font-semibold dark:text-white">
                                            Amilia Watson
                                        </h5>
                                        <Rating value={4} readonly />;
                                    </div>
                                    <p className="block lg:text-base text-sm dark:text-white">
